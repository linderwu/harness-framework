 ...
 */
export async function createDshBridgeV1({ hostId, registry, storeRoot, token, hostHandlers }) {
  ...
  const handler = createDshV1Handler({ service, authenticate, hostHandlers })
